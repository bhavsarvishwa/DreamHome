  ...
  <p>
    ...
    <?php
      ...
      for($i = ($currentpage - 1) * 10; $i < $currentpage * 10 && $i < $numrows; $i++)
      {
        ...
        $output .= listing_preview($listing_results[$i]['listing_id'], $bedrooms, $bathrooms, $basement_type, $city, $heating_type, $parking_spaces, $prices, $property_options, $property_types, $description);
      }
      echo $output;
    ?>
  </p>
